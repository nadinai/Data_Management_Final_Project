...
asylum_tidy <- asylum_all %>% select(Year, Country...territory.of.asylum.residence, 
...
# The conclusions are kept: refugees and asylum_seekers were the major types of 
# populations of concern across all continents.
...
# Analyzing demographics in 2015
...
demo_tidy %>%
  filter(year>2006, continent_res == "Europe") %>% 
...
# Using information about the number of asylum applications, we run a brief investigation
# of the share of accepted application in Germany in the recent years.
library(kableExtra)
